...
plot(ts(ii).times/3600,ts(ii).vtke/1000,base(ii).style,'Color',gnrl.cols(ii,:)); hold on
end
...
for ii=iis
plot(ts(ii).times/3600,ts(ii).CF,base(ii).style,'Color',gnrl.cols(ii,:)); hold on
end
...
sp3=subplot(143); % LWP
for ii=iis
plot(ts(ii).times/3600,ts(ii).lwp,base(ii).style,'Color',gnrl.cols(ii,:)); hold on
end
...
for ii=iis
plot(ts(ii).times/3600,ts(ii).zis,base(ii).style,'Color',gnrl.cols(ii,:)); hold on
end
for ii=iis
plot(ts(ii).times/3600,ts(ii).zcb,base(ii).style,'Color',gnrl.cols(ii,:)); hold on
end
